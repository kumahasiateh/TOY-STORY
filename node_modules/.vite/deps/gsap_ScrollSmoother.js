...
*/
var gsap, _coreInitted, _win, _doc, _docEl, _body, _toArray, _clamp, ScrollTrigger, _mainInstance, _expo, _getVelocityProp, _inputObserver, _context, _onResizeDelayedCall, _windowExists = function _windowExists() {
...
var ScrollSmoother = /* @__PURE__ */ function() {
	function ScrollSmoother(vars) {
		...
		this.offset = function(target, position, ignoreSpeed) {
			...
			if (effects) startupPhase ? ScrollTrigger.refresh() : adjustParallaxPosition([st], true);
...
//#endregion
export { ScrollSmoother, ScrollSmoother as default };
